...
### JSON function reference conventions
{: .no_toc}

This section describes the syntax and conventions for functions used for JSON manipulation using ​Firebolt​. You can use JSON functions to extract values and objects from a JSON document.
